...
_PER_FILE_LOCKS: Dict[Tuple[str, str], str] = {
    ...
    # verify_infra_V24 — 锁 bump_reverse_sha_lock.py docstring + AGENTS.md V24 段 (file-sha 双锁)
    ("verify_infra_V24.py", "EXPECTED_BUMP_REVERSE_FILE_SHA"):
        "scripts/bump_reverse_sha_lock.py (file-sha)",
    ...
    # verify_robot_009_backlog_block_policy_doc — 锁 coco/robot/sequencer.py
    # module docstring 中 ROBOT_009_OVERFLOW_POLICY_DOC 小节 (三策略文档化) file-sha
    ("verify_robot_009_backlog_block_policy_doc.py", "EXPECTED_SEQUENCER_FILE_SHA"):
        "coco/robot/sequencer.py (file-sha)",
